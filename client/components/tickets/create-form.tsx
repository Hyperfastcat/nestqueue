...
import {
  useCreateTicketQuerry,
  useTicketsQuery,
} from "@/lib/hooks/queries/tickets";
import Ticket, {
  Categories,
  Priority,
  Sites,
...
export default function CreateTicketForm({ onDismiss }: CreateTicketFormProps) {
  const { mutate: createTicket } = useCreateTicketQuerry();
  ...
  return (
    <div className="bg-gray-50 p-3 text-sm">
      ...
      <form onSubmit={handleFormSubmit}>
        ...
        <FormTextInput
          className="mb-2"
          icon={<LetterTextIcon width={16} height={16} />}
          label="Description"
        ...
        <FormTextInput
          ...
          onChange={handleFormChanged}
          placeholder="JohnDoe@digitalnest.org"
          required
        />
